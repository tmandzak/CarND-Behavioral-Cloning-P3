...
batch_size = 64    # 32 images + 32 flipped images
EPOCHS = 30        # number of training epocha
model_filename = 'model.h5'

# BehavioralCloning Class - incapsulates the solution
...
class BehavioralCloning:
    ...
    def train(self, verbose=1):
        ...
        self.history_object = self.model.fit_generator(self.train_generator,
                                     samples_per_epoch = len(self.train_log)*2,  # flipped images double num of samples
                                     validation_data = self.validation_generator, 
                                     nb_val_samples=len(self.validation_log)*2,  # flipped images double num of samples
